...
public class Globals {
	...
	public static String CONFIG_FILE       				 = System.getProperty("user.home") + "/tales-templates/tales-config.json";
	public static String AWS_CONFIG_FILE                 = System.getProperty("user.home") + "/tales-templates/aws-config.json";
